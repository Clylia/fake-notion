...
func NewJWTokenGen(issuer string, privateKey *rsa.PrivateKey) *JWTTokenGen {
	return &JWTTokenGen{
		issuer:     issuer,
		nowFunc:    time.Now,
...
func (t *JWTTokenGen) GenerateToken(accountID string, exprie time.Duration) (string, error) {
